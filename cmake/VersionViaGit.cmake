...
macro(event_fuzzy_version_from_git)
	...
	if (GIT_FOUND)
		...
		get_filename_component(_EVENT_PROJECT_SOURCE_DIR "${PROJECT_SOURCE_DIR}" REALPATH)
		get_filename_component(_EVENT_GIT_WORK_TREE "${GIT_WORK_TREE}" REALPATH)

		if ((GITRET EQUAL 0) AND (_EVENT_PROJECT_SOURCE_DIR STREQUAL _EVENT_GIT_WORK_TREE))
			execute_process(
				COMMAND
