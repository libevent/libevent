...
See [Documentation/Building](/Documentation/Building.md) for more information
...
```
$ md build && cd build
$ cmake -G "Visual Studio 10" ..   # Or whatever generator you want to use. Run cmake --help for a list.
$ start libevent.sln
```

See [Documentation/Building#Windows](/Documentation/Building.md#building-on-windows) for more information
...
$ make verify  # (optional)
```
See [Documentation/Building#Unix](/Documentation/Building.md#building-on-unix-cmake) for more information
